...
const DashboardHeader = ({
  ...
  return <header className="bg-white/80 backdrop-blur-lg border-b border-gray-200/50 sticky top-0 z-50">
      <div className="container-custom">
        <div className="flex items-center justify-between py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button variant="outline" onClick={handleLogout} size="sm" className="flex items-center gap-2 border-australis-gray/20 text-australis-gray hover:bg-australis-lightGray hover:text-australis-navy transition-all duration-200">
