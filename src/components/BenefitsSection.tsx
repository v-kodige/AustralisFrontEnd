...
const benefitCards = [{
  ...
  bullets: ["Machine learning evaluates planning, environment, heritage, grid & financial aspects", "Incorporates historical planning outcomes, grid/infrastructure proximity, environmental & regulatory constraints", "Delivers developability scores for swift, confident site selection", "Integrates seamlessly with GIS & BI platforms (ArcGIS, QGIS, Tableau, PowerBI)"]
}, {
  icon: <Map className="h-9 w-9 text-australis-aqua drop-shadow-sm" />,
  title: "Design Engine",
  subtitle: "Rapid early-stage buildability assessment",
  bullets: ["Estimates power capacity & evaluates all site constraints (spatial, topographic, regulatory)", "Integrates geospatial & engineering workflows, reducing reliance on costly design tools", "Highlights potential challenges before detailed design spend", "Exports to CAD, GIS, mapping & design platforms"]
}, {
  ...
  bullets: ["Synthesises regulatory, environmental, and heritage docs with latest legal changes", "Autonomous compliance checks mitigate manual review & risk exposure", "Proactive flagging of red/amber planning risks & next-step expert actions", "Automated reporting for regulatory evidence, due diligence & MCP integration"]
}];
        ...
        <div className="text-center mb-10">
          <div className="backdrop-blur-xl bg-white/30 border border-white/40 rounded-3xl p-8 shadow-2xl shadow-australis-navy/5 max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-australis-navy drop-shadow-sm">
              <span className="bg-gradient-to-r from-australis-indigo to-australis-aqua bg-clip-text text-transparent">Full-Spectrum Due Diligence In One Place with Agentic AI</span>
            </h2>
