        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="backdrop-blur-sm p-8 rounded-xl border border-white/10">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" variant="outline" className="border-white text-australis-navy bg-white hover:bg-transparent hover:text-white">
                Book a Demo
              </Button>
              <Button size="lg" className="bg-australis-aqua text-australis-navy hover:bg-australis-aqua/90">
                Join the Waitlist
              </Button>
            </div>
